...
"""autogenerated by genpy from memsense_imu/ImuMAG.msg. Do not edit."""
import sys
...
class ImuMAG(genpy.Message):
  _md5sum = "2e08da8dd92dede637afd3f4b4d9bf2c"
  _type = "memsense_imu/ImuMAG"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Version of sensor_msgs/Imu message 
...
float64 y
float64 z"""
  __slots__ = ['header','angular_velocity','angular_velocity_covariance','linear_acceleration','linear_acceleration_covariance','magnetic_field','magnetic_field_covariance']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,angular_velocity,angular_velocity_covariance,linear_acceleration,linear_acceleration_covariance,magnetic_field,magnetic_field_covariance
    ...
    """
    if args or kwds:
      super(ImuMAG, self).__init__(*args, **kwds)
